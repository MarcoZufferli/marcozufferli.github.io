...
images:
  - "/introducing_scripscout:transforming_smooth_ad_automation_scripts_into_attack_vectors/main_image.jpeg"
---
---
#### Table of Contents:
- [TL;DR](#30)
...
{{< image src="/introducing_scripscout:transforming_smooth_ad_automation_scripts_into_attack_vectors/main_image.jpeg" position="center" style="border-radius: 8px;">}}
...
Knowing this, the attacker could, for example, use the tool ["dnstool.py"](https://github.com/dirkjanm/krbrelayx/blob/master/dnstool.py) (or also [adddns.py](https://github.com/decoder-it/KrbRelayEx/blob/master/adddns.py)) to insert a DNS A record that will point the machine name "notexistcomputer" to the IP address belonging to the attacker's machine.
